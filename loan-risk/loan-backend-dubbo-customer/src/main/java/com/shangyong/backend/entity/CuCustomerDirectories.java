 ...
 **/
public class CuCustomerDirectories implements Serializable {
	...
	/**联系人状态、1:正常 2:异类号码 3:异常号码 4:异常加异类号码**/
	...
	public CuCustomerDirectories(String directoriesId, Integer appName, String customerId, String contactName,
			String contactPhone, String createTime, String modifyTime, Integer ifMobile, String districtNumber,
			Integer directoriesState, String extend) {
		super();
