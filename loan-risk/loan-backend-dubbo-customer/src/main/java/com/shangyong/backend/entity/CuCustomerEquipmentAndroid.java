 ...
 **/
public class CuCustomerEquipmentAndroid implements Serializable {
	...
	public CuCustomerEquipmentAndroid() {
		super();
	}

	public CuCustomerEquipmentAndroid(String equipmentId, String customerId, Integer appName, String baseStationInfo,
