...
import com.shangyong.backend.common.BaseBo;
...
public class CuPlatformCustomer extends BaseBo implements Serializable {
	...
	public CuPlatformCustomer(String platformCustomerId, String customerId, String appName, String name,
			...
			String registeredAddress, String contactAddress, String bankName, String nation, String birth, String createTime, String createMan, String modifyTime,
