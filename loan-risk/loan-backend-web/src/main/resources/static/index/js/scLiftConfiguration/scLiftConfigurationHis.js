...
var channelName = "", appLevel = "", beginTime1="" ,endTime1="",scLiftConfigurationId="",state = "";
// 条件搜索
function sel() {
...
function getList(_pageIndex) {
	...
	layui.use([ 'paging', 'layer', 'form', 'element','laydate' ],
			function() {
						...
						paging.init({
									openWait : true,
									url : getCtxPath() + "/backend/scLiftConfigurationHis/scLiftConfigurationHisListAll.do?v=" + new Date().getTime(),
									elem : '#content', // 内容容器
									params : { // 发送到服务端的参数
										appLevel : appLevel,
