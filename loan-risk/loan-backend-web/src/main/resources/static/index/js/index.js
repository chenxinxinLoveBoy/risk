...
//function getMenuAll(){
//	$.ajax({
//		url : hostIp + "/menu/listAll.do",
//		method : 'get',
//		dataType : 'json',
//		success : function(data) {
//			$.each(data.data.data.authorityLists, function(k, v) {
//				 navs.push(v);
//			});
//			
//			sysUserName = data.data.data.sysUserName;
//		},
//		error: function(){
//			alert("获取数据失败，请尝试重新登陆！");
//		},
//		complete: function(){
//			$("#sysUserName").html(sysUserName);
//		}
//	});
//}
