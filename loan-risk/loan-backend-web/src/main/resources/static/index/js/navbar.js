    ...
    Navbar.prototype.render = function () {
        ...
        if (_config.data !== undefined && typeof (_config.data) === 'object') {
            ...
            if (_config.cached) {
                ...
                if (cacheNavbar.navbar === undefined) {
                    $.ajax({
                        ...
                        error: function (xhr, status, error) {
                            common.msgError('error: 请求网络异常，请尝试刷新页面重新登录！');
                        },
                ...
                var get_url = _config.url;// url
                if(get_url == null || get_url == '' || get_url == undefined){
                	common.msgError("获取菜单url为空！");
                	return;
                }
                $.ajax({
                    type: _config.type,
