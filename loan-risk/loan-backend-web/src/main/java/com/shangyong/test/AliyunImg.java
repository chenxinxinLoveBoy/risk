...
/**
 * 阿里云OSS存储测试类（上传图片和获取图片显示UL）
 * @author xiajiyun
 *
 */
public class AliyunImg {
	 static Logger logger = Logger.getLogger(AliyunImg.class);
	    ...
	    private static String bucketName = "shandai-test-oss";

	    // Object是OSS存储数据的基本单元，称为OSS的对象，也被称为OSS的文件。详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
	    // Object命名规范如下：使用UTF-8编码，长度必须在1-1023字节之间，不能以“/”或者“\”字符开头。
//	    private static String firstKey = "my-first-key1222";
...
//	            ossClient.putObject(bucketName, fileKey, new File("C:\\xiajiyun\\xiajiyun.txt"));
//	            System.out.println("Object：" + fileKey + "存入OSS成功。");
	            
	            // 上传文件流
	            InputStream is2 = new FileInputStream("C:\\Users\\xiajiyun\\Desktop\\Img\\tuzi2.jpg");
	            ossClient.putObject(bucketName, "jdskladjsklad/2017-06-12-15-361.jpg", is2);
...
//	            System.out.println("删除Object：" + fileKey + "成功。");
	     ...
	     // 生成URL
	        URL url = ossClient.generatePresignedUrl(bucketName, "jdskladjsklad/2017-06-12-15-361.jpg", expiration);
