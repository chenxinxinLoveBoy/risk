...
import com.shangyong.backend.service.task.impl.NewTaskServiceImpl;
...
@Component
public class NewTongDunFacilityApplicationRemindJob implements Job {

    private static Logger tdFacililtyLogger = LoggerFactory.getLogger("tdFacility");

    @Autowired
    private NewTdLoanInterfaceService tdLoanInterfaceService;

    @Autowired
    private NewTaskServiceImpl taskServiceImpl;
    ...
    public static Object getObject() {
        NewTongDunFacilityApplicationRemindJob instance = (NewTongDunFacilityApplicationRemindJob) SpringContextUtils.getBean(NewTongDunFacilityApplicationRemindJob.class);
        return instance;
    }
