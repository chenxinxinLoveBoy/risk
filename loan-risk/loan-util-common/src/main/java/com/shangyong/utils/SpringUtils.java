...
import com.shangyong.common.DwzResult;
import com.shangyong.common.JsonResult;
...
//			response.getOutputStream().write(content.getBytes()); // 将 getWriter() 改成 getOutputStream(),否则会报错
	 ...
	 * 
	 */
	public static void renderJsonArray(HttpServletResponse response,
                                       final Object object, final String... headers) {
