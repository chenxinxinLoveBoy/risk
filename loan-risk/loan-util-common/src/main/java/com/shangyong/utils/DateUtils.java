...
public class DateUtils {
	...
	public static List<String> getSortDate(List<String> dateList,String regx){
		Collections.sort(dateList,new Comparator<String>() {
			@Override
			public int compare(String str1, String str2) {
				Date d1, d2;
				try {
					d1 = new SimpleDateFormat("yyyy-MM").parse(str1);
					d2 = new SimpleDateFormat("yyyy-MM").parse(str2);
				} catch (ParseException e) {
