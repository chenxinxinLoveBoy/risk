 ...
 **/
public class BqsRepMnoOneMobile {

	/****/
	private String bqsMnoOneInfoId;
	...
	public BqsRepMnoOneMobile() {
		super();
	}
	public BqsRepMnoOneMobile(String bqsMnoOneInfoId,String bqsPetitionerId,String mobile,String mobileTag,String mobileTagType,String financeTag,String beginTime,String endTime,String monType,String belongTo,String connectCount,String connectTime,String originatingCallCount,String originatingTime,String terminatingCallCount,String terminatingTime) {
		super();
		this.bqsMnoOneInfoId = bqsMnoOneInfoId;
	...
	public void setBqsMnoOneInfoId(String bqsMnoOneInfoId){
		this.bqsMnoOneInfoId = bqsMnoOneInfoId;
	}

	public String getBqsMnoOneInfoId(){
		return this.bqsMnoOneInfoId;
	}
