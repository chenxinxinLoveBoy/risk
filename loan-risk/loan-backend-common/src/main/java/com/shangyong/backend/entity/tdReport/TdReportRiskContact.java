 ...
 **/
public class TdReportRiskContact {

	/**唯一标识**/
	private String riskContactId;
	...
	public void setRiskContactId(String riskContactId){
		this.riskContactId = riskContactId;
	}

	public String getRiskContactId(){
		return this.riskContactId;
	}
