 ...
 **/
public class BqsRepMnoThreeDayMobile {

	/****/
	private String bqsMnoThreeDayInfoId;
	...
	public BqsRepMnoThreeDayMobile() {
		super();
	}
	public BqsRepMnoThreeDayMobile(String bqsMnoThreeDayInfoId,String bqsPetitionerId,String mobile,String mobileTag,String mobileTagType,String financeTag,String beginTime,String endTime,String monType,String belongTo,String connectCount,String connectTime,String originatingCallCount,String originatingTime,String terminatingCallCount,String terminatingTime) {
		super();
		this.bqsMnoThreeDayInfoId = bqsMnoThreeDayInfoId;
	...
	public void setBqsMnoThreeDayInfoId(String bqsMnoThreeDayInfoId){
		this.bqsMnoThreeDayInfoId = bqsMnoThreeDayInfoId;
	}

	public String getBqsMnoThreeDayInfoId(){
		return this.bqsMnoThreeDayInfoId;
	}
