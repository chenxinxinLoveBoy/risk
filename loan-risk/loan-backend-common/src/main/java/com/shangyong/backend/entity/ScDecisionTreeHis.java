 ...
 **/
public class ScDecisionTreeHis extends BaseBo {

	/** 决策树历史表序号ID **/
	private Integer decisionTreeHisId;
	...
	public ScDecisionTreeHis() {
		super();
	}

	

	public ScDecisionTreeHis(Integer decisionTreeHisId, Integer decisionTreeId, String decisionTreeCode,
			String decisionTreeName, String startTime, String endTime, String tplPercent, Integer executeType,
			Integer level, Integer banControlTplId, String fraudRuleTplId, Integer scoreTplId, String state,
			String exchanges, Integer version, String createTime, String createMan, String createName,
			String modifyTime, String modifyMan, String modifyName, String remark, String implementType,
			String recordNewtime, String beginTime1, String endTime1) {
		super();
		this.decisionTreeHisId = decisionTreeHisId;
	...
	public Integer getDecisionTreeHisId() {
		return decisionTreeHisId;
	}

	public void setDecisionTreeHisId(Integer decisionTreeHisId) {
		this.decisionTreeHisId = decisionTreeHisId;
	}
