 ...
 **/
public class BqsRepMnoSixMobile {

	/****/
	private String bqsMnoSixInfoId;
	...
	public BqsRepMnoSixMobile() {
		super();
	}
	public BqsRepMnoSixMobile(String bqsMnoSixInfoId,String bqsPetitionerId,String mobile,String mobileTag,String mobileTagType,String financeTag,String beginTime,String endTime,String monType,String belongTo,String connectCount,String connectTime,String originatingCallCount,String originatingTime,String terminatingCallCount,String terminatingTime) {
		super();
		this.bqsMnoSixInfoId = bqsMnoSixInfoId;
	...
	public void setBqsMnoSixInfoId(String bqsMnoSixInfoId){
		this.bqsMnoSixInfoId = bqsMnoSixInfoId;
	}

	public String getBqsMnoSixInfoId(){
		return this.bqsMnoSixInfoId;
	}
