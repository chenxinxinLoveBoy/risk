 ...
 **/
public class BqsRepMnoPeriodUsed {

	/****/
	private String bqsMnoPeriodUsedId;
	...
	public BqsRepMnoPeriodUsed() {
		super();
	}
	public BqsRepMnoPeriodUsed(String bqsMnoPeriodUsedId,String bqsPetitionerId,String mobile,String periodType,String mnoType,String belongTo,String originatingCallCount,String originatingCallTime,String terminatingCallCount,String terminatingCallTime,String msgCount) {
		super();
		this.bqsMnoPeriodUsedId = bqsMnoPeriodUsedId;
	...
	public void setBqsMnoPeriodUsedId(String bqsMnoPeriodUsedId){
		this.bqsMnoPeriodUsedId = bqsMnoPeriodUsedId;
	}

	public String getBqsMnoPeriodUsedId(){
		return this.bqsMnoPeriodUsedId;
	}
