 ...
 * @throws Throwable
 */  
public class MhXueXinUploadImgUtil  { 

	private static Logger logger = Logger.getLogger(MhXueXinUploadImgUtil.class);
...
/*	@Autowired
	...
	*/
	 ...
	 * @throws Throwable
	 */ 
	public static String uploadFilesImg(String base64)
			throws Throwable {
