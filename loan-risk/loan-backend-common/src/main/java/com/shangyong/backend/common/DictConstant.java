...
public class DictConstant {
	 ...
	 * 新用户提现模板业务编号key
	 */
	public static final String PRESENT_RULE_NEW_CUST_TEMPLATE_ID_KEY_NAME = "PRESENT_RULE_NEW_CUST_TEMPLATE_ID";
	/**
	 * 老用户提现模板业务编号key
	 */
	public static final String PRESENT_RULE_OLD_CUST_TEMPLATE_ID_KEY_NAME = "PRESENT_RULE_OLD_CUST_TEMPLATE_ID";
	 ...
	 * 新用户准入规则业务编号key
	 */
	public static final String NEW_CUST_ADMITTANCE_TEMPLATE_ID_KEY_NAME = "NEW_CUST_ADMITTANCE_TEMPLATE_ID";
	/**
	 * 老用户准入规则业务编号key
	 */
	public static final String OLD_CUST_ADMITTANCE_TEMPLATE_ID_KEY_NAME = "OLD_CUST_ADMITTANCE_TEMPLATE_ID";
	...
	/**
	 * 新用户准入规则-手机联系人个数-正常的联系人
	 */
	public static final String XIAO_NIU_CONTACTS = "1300007";

	/** 通讯录正常的联系人 **/
	public final static String PLATFORM_FRAUD_DIRECTORIES = "1300007";
	
	public static final String MQ_ROUTING_PRESENT_BIG_DICT = "MQ_ROUTING_PRESENT_BIG_DICT";
}
