...
public class DateUtils {
	 ...
	 * @return
	 */
	 public static String finLastSevenDaysMorning() {
		...
		String lastSevenDaysMorning = sdf.format(dBefore);    //格式化前7天
		lastSevenDaysMorning = lastSevenDaysMorning+" 00:00:00";
		return lastSevenDaysMorning; 
	 }
	 /**
	  * 计算昨天晚上时间 23:59:59
	  * @return
	  */
	 public static String finYesterdayNight() {
		Date dNow = new Date();   //当前时间
		Date dBefore = new Date();
		Calendar calendar = Calendar.getInstance(); //得到日历
		calendar.setTime(dNow);//把当前时间赋给日历
		...
		String yesterdayNight = defaultStartDate.substring(0,10)+" 23:59:59";
