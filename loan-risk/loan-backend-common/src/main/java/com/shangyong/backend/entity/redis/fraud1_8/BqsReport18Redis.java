...
/**
 * @Description  白骑士的报告数据的redis库 (运营商)
 * @Author  Corey
 * @Date  2018/4/11 16:23
 */
public class BqsReport18Redis {
    ...
    public HashMap<String,String> toMap(){
        ...
        map.put("carrierCallInOutCnt3mRatioCallCountHc", ("null".equals(this.carrierCallInOutCnt3mRatioCallCountHc) || null == this.carrierCallInOutCnt3mRatioCallCountHc) ? "unknow" : this.carrierCallInOutCnt3mRatioCallCountHc);
        ...
        map.put("carrierCallOutCnt01CallCount", ("null".equals(this.carrierCallOutCnt01CallCount) || null == this.carrierCallOutCnt01CallCount) ? "unknow" : this.carrierCallOutCnt01CallCount);
        map.put("carrierCallOutCnt01CallCountAll", ("null".equals(this.carrierCallOutCnt01CallCountAll) || null == this.carrierCallOutCnt01CallCountAll) ? "unknow" : this.carrierCallOutCnt01CallCountAll);
