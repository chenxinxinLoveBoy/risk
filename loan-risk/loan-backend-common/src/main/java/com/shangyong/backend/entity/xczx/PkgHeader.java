...
public class PkgHeader {
	...
	public String toPkgStr(Charset charset) {
		...
		String result = this.getVersion() + "|" + this.getCustNo() + "|" + this.getEncode() + "|" + this.getTrxCode()
				+ "|" + this.getEncryptType() + "|" + this.getMsgType() + "|" + msgBody + "|" + this.getRetCode() + "|"
				+ retMsg + "|" + this.getSign();
	...
	public String toString() {
		return "PkgHeader [version=" + version + ", custNo=" + custNo + ", encode=" + encode + ", trxCode=" + trxCode
				+ ", encryptType=" + encryptType + ", msgType=" + msgType + ", msgBody=" + msgBody + ", retCode="
				+ retCode + ", retMsg=" + retMsg + ", sign=" + sign + "]";
	}
