 ...
 */
@JsonAutoDetect
public class Emergency_contact5_detail {
	...
	@JsonProperty("contact_attribute")
	...
	@JsonProperty("first_time_call_6month")
	...
	@JsonProperty("is_virtual_number")
	...
	@JsonProperty("average_gap_day_call_6month")
    private String averageGapDayCall6month;
	@JsonProperty("contact_number")
    private String contactNumber;
	@JsonProperty("contact_area")
    private String contactArea;
	@JsonProperty("call_count_1week")
    private String callCount1week;
	@JsonProperty("contact_seq_no")
    private String contactSeqNo;
	@JsonProperty("is_whole_day_call_3month")
    private String isWholeDayCall3month;
	@JsonProperty("max_gap_day_call_6month")
