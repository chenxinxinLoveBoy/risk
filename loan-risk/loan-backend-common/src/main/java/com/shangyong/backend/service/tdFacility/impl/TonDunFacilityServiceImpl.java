...
import com.shangyong.backend.dao.tdf.TdFacilityAttributionCreditScoreServiceDao;
...
import com.shangyong.backend.dao.tdf.TdFacilityFraudServiceDao;
import com.shangyong.backend.dao.tdf.TdFacilityGeoIpServiceDao;
import com.shangyong.backend.dao.tdf.TdFacilityHitRuleServiceDao;
import com.shangyong.backend.dao.tdf.TdFacilityPolicySetServiceDao;
...
import com.shangyong.backend.entity.tdf.jackson.common.Attribution;
import com.shangyong.backend.entity.tdf.jackson.common.Credit_score;
import com.shangyong.backend.entity.tdf.jackson.common.Device_info;
import com.shangyong.backend.entity.tdf.jackson.common.GeoIp;
import com.shangyong.backend.entity.tdf.jackson.common.Hit_rules;
import com.shangyong.backend.entity.tdf.jackson.common.Policy_set;
import com.shangyong.backend.entity.tdf.jackson.common.TdFacilityJsonIos;
 ...
 */
@Service
public class TonDunFacilityServiceImpl implements TonDunFacilityService {
	/** 同盾设备指纹日志**/
	...
	public RuleResult acquire(Application application) {
		...
		try {
			...
			//存阿里云
	        jsonReportService.uploadJson(Constants.TD_FACILITY_UPLOAD_DIR, resultJson, TaskTypeConstants.TD_FACILITY_TYPE, TaskTypeConstants.TD_FACILITY_NAME, TaskTypeConstants.TD_FACILITY_ISEND, application.getApplicationId(), "noext");
