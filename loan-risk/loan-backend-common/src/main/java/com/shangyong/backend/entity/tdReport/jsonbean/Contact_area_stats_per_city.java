...
public class Contact_area_stats_per_city {
	@JsonProperty("call_count_holiday_3month")
    private String callCountHoliday3month;
	@JsonProperty("call_count_call_time_over10min_6month")
    private String callCountCallTimeOver10min6month;
	@JsonProperty("contact_count_active_3month")
    private String contactCountActive3month;
	@JsonProperty("call_count_active_6month")
    private String callCountActive6month;
	@JsonProperty("call_time_1month")
    private String callTime1month;
	@JsonProperty("call_time_6month")
    private String callTime6month;
	@JsonProperty("contact_area_city")
    private String contactAreaCity;
	@JsonProperty("call_count_late_night_6month")
    private String callCountLateNight6month;
	@JsonProperty("call_count_passive_6month")
    private String callCountPassive6month;
	@JsonProperty("call_time_active_6month")
    private String callTimeActive6month;
	@JsonProperty("msg_count_6month")
    private String msgCount6month;
	@JsonProperty("contact_count_passive_6month")
    private String contactCountPassive6month;
	@JsonProperty("call_count_call_time_5min10min_6month")
    private String callCountCallTime5min10min6month;
	@JsonProperty("call_time_late_night_6month")
    private String callTimeLateNight6month;
	@JsonProperty("call_count_3month")
    private String callCount3month;
	@JsonProperty("contact_count_1month")
    private String contactCount1month;
	@JsonProperty("call_count_work_time_3month")
    private String callCountWorkTime3month;
	@JsonProperty("call_count_workday_3month")
    private String callCountWorkday3month;
	@JsonProperty("call_count_6month")
    private String callCount6month;
	@JsonProperty("call_count_offwork_time_3month")
    private String callCountOffworkTime3month;
	@JsonProperty("call_time_offwork_time_6month")
    private String callTimeOffworkTime6month;
	@JsonProperty("call_count_offwork_time_6month")
    private String callCountOffworkTime6month;
	@JsonProperty("call_time_offwork_time_3month")
    private String callTimeOffworkTime3month;
	@JsonProperty("contact_count_mutual_3month")
    private String contactCountMutual3month;
	@JsonProperty("call_count_1month")
    private String callCount1month;
	@JsonProperty("call_time_passive_3month")
    private String callTimePassive3month;
	@JsonProperty("call_count_call_time_less1min_6month")
    private String callCountCallTimeLess1min6month;
	@JsonProperty("contact_count_call_count_over10_3month")
    private String contactCountCallCountOver103month;
	@JsonProperty("call_count_workday_6month")
    private String callCountWorkday6month;
	@JsonProperty("contact_count_call_count_over10_6month")
    private String contactCountCallCountOver106month;
	@JsonProperty("msg_count_1month")
    private String msgCount1month;
	@JsonProperty("contact_count_mutual_6month")
    private String contactCountMutual6month;
	@JsonProperty("call_count_call_time_1min5min_6month")
    private String callCountCallTime1min5min6month;
	@JsonProperty("call_count_holiday_6month")
    private String callCountHoliday6month;
	@JsonProperty("contact_count_active_6month")
    private String contactCountActive6month;
	@JsonProperty("call_time_3month")
    private String callTime3month;
	@JsonProperty("msg_count_3month")
    private String msgCount3month;
	@JsonProperty("call_time_passive_6month")
    private String callTimePassive6month;
	@JsonProperty("call_count_active_3month")
    private String callCountActive3month;
	@JsonProperty("call_count_late_night_3month")
    private String callCountLateNight3month;
	@JsonProperty("call_time_work_time_6month")
    private String callTimeWorkTime6month;
	@JsonProperty("call_count_work_time_6month")
    private String callCountWorkTime6month;
	@JsonProperty("call_time_late_night_3month")
    private String callTimeLateNight3month;
	@JsonProperty("call_time_active_3month")
    private String callTimeActive3month;
	@JsonProperty("contact_count_passive_3month")
    private String contactCountPassive3month;
	@JsonProperty("call_count_passive_3month")
    private String callCountPassive3month;
	@JsonProperty("call_time_work_time_3month")
    private String callTimeWorkTime3month;
	@JsonProperty("contact_count_3month")
    private String contactCount3month;
	@JsonProperty("contact_area_seq_no")
    private String contactAreaSeqNo;
	@JsonProperty("contact_count_6month")
