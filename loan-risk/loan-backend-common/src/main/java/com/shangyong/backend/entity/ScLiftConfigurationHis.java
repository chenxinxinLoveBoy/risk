 ...
 **/
public class ScLiftConfigurationHis extends BaseBo {

	/** 提额配置历史Id **/
	private Integer scLiftConfigurationHisId;
	...
	public ScLiftConfigurationHis() {
		super();
	}

	public ScLiftConfigurationHis(Integer scLiftConfigurationHisId, Integer scLiftConfigurationId, String channelName,
			Integer appLevel, String creditMoney, Integer isAccumulationFund, Integer isSocialSecurity,
			Integer repaymentTimes, Integer todayTimes, String percentageOfLift, Integer percentageOfLiftMantissa,
			Integer version, String createTime, String createMan, String createName, String modifyTime,
			String modifyMan, String modifyName, String remark, String state, String mateName, String matePhone,
			String mateCertCode, String recordNewtime, String beginTime1, String endTime1) {
		super();
		this.scLiftConfigurationHisId = scLiftConfigurationHisId;
	...
	public Integer getScLiftConfigurationHisId() {
		return scLiftConfigurationHisId;
	}

	public void setScLiftConfigurationHisId(Integer scLiftConfigurationHisId) {
		this.scLiftConfigurationHisId = scLiftConfigurationHisId;
	}
