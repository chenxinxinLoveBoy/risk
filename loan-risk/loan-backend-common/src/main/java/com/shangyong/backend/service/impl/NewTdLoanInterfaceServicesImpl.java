...
import com.shangyong.backend.dao.approval.AppUserDao;
import com.shangyong.backend.dubbo.impl.GetCustomerInfoService;
import com.shangyong.backend.entity.*;
import com.shangyong.backend.entity.approval.AppUser;
import com.shangyong.backend.service.NewTdLoanInterfaceService;
 ...
 */
@Service
public class NewTdLoanInterfaceServicesImpl implements NewTdLoanInterfaceService {

    private static Logger logger = LoggerFactory.getLogger(NewTdLoanInterfaceServicesImpl.class);
    ...
    public Map<String, Object> getCustApplicationList(Map<String, Object> dataMap) {
		...
		//根据申请单的平台客户编号，获取客户资料
//		AppUser appUser1 = appUserDao.findAppUserByUserNo(Long.parseLong(customerId));
//		if(appUser1 == null || appUser1.getId() == null){
//			throw new RuntimeException("未找到用户信息请确认用户存在");
//		}
