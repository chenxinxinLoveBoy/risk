 ...
 **/
public class TxyAntiFraud implements Serializable{
	...
	public TxyAntiFraud(String txyAntiFraudId, String buApplicationId, String code, String codeDesc, String message,
			String idFound, String found, String riskScore, String userIp, String state, String createTime,
			String createMan, String modifyTime, String modifyMan, String remark) {
		super();
		this.txyAntiFraudId = txyAntiFraudId;
		this.buApplicationId = buApplicationId;
		this.code = code;
